            ...
            <div className="mb-12 max-w-2xl mx-auto">
                <div className="relative">
                    <input
                        ...
                        className="w-full px-6 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm placeholder:text-xs 
